...
public class TextRenderer {
    ...
    protected gov.side.worldwind.render.Color textColor;
    ...
    protected gov.side.worldwind.render.Color outlineColor;
    ...
    public gov.side.worldwind.render.Color getTextColor() {
        return this.textColor;
    }

    public void setTextColor(gov.side.worldwind.render.Color color) {
    ...
    public gov.side.worldwind.render.Color getOutlineColor() {
        return this.outlineColor;
    }

    public void setOutlineColor(gov.side.worldwind.render.Color outlineColor) {
