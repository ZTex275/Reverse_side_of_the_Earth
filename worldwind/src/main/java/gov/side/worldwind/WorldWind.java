...
import gov.side.worldwind.geom.Ellipsoid;
import gov.side.worldwind.util.MessageService;
import gov.side.worldwind.util.TaskService;
...
public class WorldWind {
     ...
     */
    public static final String REQUEST_REDRAW = "gov.side.worldwind.RequestRedraw";
