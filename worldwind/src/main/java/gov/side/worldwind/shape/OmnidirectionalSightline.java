...
import gov.side.worldwind.draw.DrawableSightline;
import gov.side.worldwind.geom.BoundingSphere;
...
import gov.side.worldwind.render.SightlineProgram;
...
public class OmnidirectionalSightline extends AbstractRenderable implements Attributable, Highlightable, Movable {
    ...
    /**
     * The sightline's altitude mode. See {@link gov.side.worldwind.WorldWind.AltitudeMode}
     */
