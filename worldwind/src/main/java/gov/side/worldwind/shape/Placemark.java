...
import gov.side.worldwind.draw.DrawableLines;
import gov.side.worldwind.draw.DrawableScreenTexture;
import gov.side.worldwind.geom.Matrix4;
import gov.side.worldwind.geom.Position;
import gov.side.worldwind.geom.Vec2;
import gov.side.worldwind.geom.Vec3;
import gov.side.worldwind.geom.Viewport;
import gov.side.worldwind.globe.Globe;
...
import gov.side.worldwind.util.WWMath;
...
public class Placemark extends AbstractRenderable implements Highlightable, Movable {
    ...
    /**
     * The placemark's altitude mode. See {@link gov.side.worldwind.WorldWind.AltitudeMode}
     */
...
//    protected String label;
     ...
     * See {@link gov.side.worldwind.WorldWind.OrientationMode}
     */
     ...
     * {@link gov.side.worldwind.WorldWind.OrientationMode}
     */
    @WorldWind.OrientationMode
...
//    }
     ...
     *
     * @param altitudeMode The new altitude mode. See {@link gov.side.worldwind.WorldWind.AltitudeMode} for acceptable
     *                     values
     *
     * @return This placemark
     */
...
//    }
     ...
     *
     * @return The {@link gov.side.worldwind.WorldWind.OrientationMode} to use when image rotation applied.
     */
    @WorldWind.OrientationMode
     ...
     * orientation relative to the globe.
     *
     * @param imageRotationReference The {@link gov.side.worldwind.WorldWind.OrientationMode} to use when image rotation
     *                               applied.
     *
     * @return This placemark.
     */
     ...
     *
     * @return The {@link gov.side.worldwind.WorldWind.OrientationMode} to use when the image is tilted.
     */
    @WorldWind.OrientationMode
     ...
     * orientation relative to the surface.
     *
     * @param imageTiltReference The {@link gov.side.worldwind.WorldWind.OrientationMode} to use when the image is
     *                           tilted.
     *
     * @return This placemark.
     */
