...
public class Label extends AbstractRenderable implements Highlightable, Movable {
    ...
    /**
     * The label's altitude mode. See {@link gov.side.worldwind.WorldWind.AltitudeMode}
     */
     ...
     *
     * @return the altitude mode, see {@link gov.side.worldwind.WorldWind.AltitudeMode} for possible
     */
    @WorldWind.AltitudeMode
